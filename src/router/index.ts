        ...
        children: [
          {
            name: 'rol',
            path: 'rol',
            component: () => import('../pages/admin/roles/crear_rol.vue'),
          },
          {
            name: 'tipo_equipos',
            path: 'tipo_equipos',
            component: () => import('../pages/admin/tipo_equipo/equipos.vue'),
          },
          {
            name: 'equipos',
            path: 'equipos',
            component: () => import('../pages/admin/equipos/equipos.vue'),
          },
          {
            name: 'estado_equipos',
            path: 'estado_equipos',
            component: () => import('../pages/admin/estado_equipo/estado_equipo.vue'),
          },
          {
            name: 'estado_prestamo',
            path: 'estado_prestamo',
            component: () => import('../pages/admin/estado_prestamo/estado_pretamo.vue'),
          },
          {
            name: 'prestamo',
            path: 'prestamo',
            component: () => import('../pages/admin/prestamo/prestamo.vue'),
          },
        ],
      },
      {
